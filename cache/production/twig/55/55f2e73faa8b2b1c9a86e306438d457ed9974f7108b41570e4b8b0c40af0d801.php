...
/* posting_editor.html */
class __TwigTemplate_fc673c8c878a028cec873a6c3fcaedcd1646a66bc44a725d0122c8f610aba003 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
                // line 142
                $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                $this->env->setNamespaceLookUpOrder(array('postimage_imageupload', '__main__'));
                $this->env->loadTemplate('@postimage_imageupload/event/posting_editor_options_prepend.html')->display($context);
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                // line 143
                echo "\t\t\t";
                if (($context["S_BBCODE_ALLOWED"] ?? null)) {
